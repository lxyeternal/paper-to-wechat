...
digest: ASE 2026 接收名单公布，我们把与软件供应链安全相关的论文挑出来做了一期盘点：24 篇，覆盖包与生态治理、智能体供应链、依赖与构建、漏洞与补丁传播、签名与发布防线、工业界轨六个方向，每篇都给了标题和一句话导读。
author: 供应链安全前沿
venue: ASE 2026
collection: 供应链攻击与防御
highlights:
...
其一，**这份名单是逐篇过出来的，但不敢说全**。ASE 2026 研究轨接收了 200 多篇，我是把接收列表按字母顺序整个过了一遍再自己判断相关性，不是丢几个关键词让工具筛。但抓取受限，字母 Q 到 Z 那一段没能完整拿到，==所以这一期确定覆盖 A 到 P，后半段可能有遗漏==，欢迎在留言区补。
...
Industry Showcase 轨更贴近真实生产环境的约束，这几篇值得单独看。
